        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandPrimaryColor = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    BrandSecondaryColor = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageShelfLifeDays = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KarmaScore = table.Column<int>(type: "integer", nullable: false, defaultValue: 100),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buildings_Operators_OperatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiConfidenceScore = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasSharedKitchen = table.Column<bool>(type: "boolean", nullable: false),
                    HasSharedLounge = table.Column<bool>(type: "boolean", nullable: false),
                    HasLaundry = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedById = table.Column<string>(type: "text", nullable: true),
                    UpdatedById = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResidentNotifications_Buildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResidentNotifications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialization = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    IsOnShift = table.Column<bool>(type: "boolean", nullable: false),
                    ShiftStartedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_Apartments_ApartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chores_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Chores_Users_AssignedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryItems_ProductCatalogs_CatalogItemId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItems_Users_UpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurringChores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecurringChores_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecurringChores_Users_AssignedUserId",
                        column: x => x.AssignedUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringExpenses_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SquareMeters = table.Column<decimal>(type: "numeric(6,2)", nullable: true),
                    MonthlyRent = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Settlements_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentMembers_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApartmentMembers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedStaffAssignmentId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    ResidentFeedback = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedById = table.Column<string>(type: "text", nullable: true),
                    UpdatedById = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequests_StaffAssignments_AssignedStaffAssignmen~",
                        column: x => x.AssignedStaffAssignmentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentMembers_ApartmentId",
                table: "ApartmentMembers",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentMembers_RoomId_IsActive",
                table: "ApartmentMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartments_InviteCode",
                table: "Apartments",
                column: "InviteCode");

            migrationBuilder.CreateIndex(
                name: "IX_Buildings_Country_City",
                table: "Buildings",
                columns: new[] { "Country", "City" });

            migrationBuilder.CreateIndex(
                name: "IX_Buildings_OperatorId",
                table: "Buildings",
                column: "OperatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chores_ApartmentId",
                table: "Chores",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Chores_AssignedUserId",
                table: "Chores",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_ApartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_UpdatedById",
                table: "InventoryItems",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequests_AssignedStaffAssignmentId_Status",
                table: "MaintenanceRequests",
                columns: new[] { "AssignedStaffAssignmentId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringChores_ApartmentId",
                table: "RecurringChores",
                column: "ApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringChores_AssignedUserId",
                table: "RecurringChores",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringExpenses_ApartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidentNotifications_BuildingId_CreatedAt",
                table: "ResidentNotifications",
                columns: new[] { "BuildingId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ResidentNotifications_UserId_CreatedAt",
                table: "ResidentNotifications",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_ApartmentId_Number",
                table: "Rooms",
                columns: new[] { "ApartmentId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Settlements_ApartmentId",
                table: "Settlements",
                column: "ApartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffAssignments_BuildingId_Role_IsActive",
                table: "StaffAssignments",
                columns: new[] { "BuildingId", "Role", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffAssignments_UserId_BuildingId_Role",
                table: "StaffAssignments",
                columns: new[] { "UserId", "BuildingId", "Role" },
                unique: true,
